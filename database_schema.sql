...
--
-- Host: localhost    Database: musician_social_platform
-- ------------------------------------------------------
...
CREATE TABLE `game_results` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `game_results_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `music_games`
--

DROP TABLE IF EXISTS `music_games`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `music_games` (
  `id` int NOT NULL AUTO_INCREMENT,
  `level` int NOT NULL,
  `game_type` varchar(50) NOT NULL,
  `question` text NOT NULL,
  `audio_file` varchar(255) DEFAULT NULL,
  `target_sequence` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `user_music_styles`
--

DROP TABLE IF EXISTS `user_music_styles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_music_styles` (
  ...
  CONSTRAINT `user_music_styles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_music_styles_ibfk_2` FOREIGN KEY (`style_id`) REFERENCES `music_styles` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `music_level` varchar(30) DEFAULT 'Not Ranked',
...
-- Dump completed on 2026-09-23 13:04:12
